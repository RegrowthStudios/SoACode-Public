...
namespace vorb {
    namespace graphics {
        ...
        public:
            ...
            void addProgram(nString shaderName, vg::GLProgram* program);

            /// Gets a shader from the cache
            /// returns nullptr if the shader doesn't exist
            vg::GLProgram* getProgram(nString shaderName) const;
        ...
        private:
            ...
            std::unordered_map<nString, vg::GLProgram*> _programs;
        };
    }
}
