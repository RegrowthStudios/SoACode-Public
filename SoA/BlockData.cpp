...
KEG_TYPE_INIT_DEF_VAR_NAME->addValue("movesPowder", Keg::Value::basic(Keg::BasicType::UI8, offsetof(Block, powderMove)));
...
KEG_TYPE_INIT_DEF_VAR_NAME->addValue("scatterSunRays", Keg::Value::basic(Keg::BasicType::UI8, offsetof(Block, blockLight)));
KEG_TYPE_INIT_DEF_VAR_NAME->addValue("useable", Keg::Value::basic(Keg::BasicType::UI8, offsetof(Block, useable)));
KEG_TYPE_INIT_DEF_VAR_NAME->addValue("allowsLight", Keg::Value::basic(Keg::BasicType::UI8, offsetof(Block, allowLight)));
KEG_TYPE_INIT_DEF_VAR_NAME->addValue("crushable", Keg::Value::basic(Keg::BasicType::UI8, offsetof(Block, isCrushable)));
KEG_TYPE_INIT_DEF_VAR_NAME->addValue("supportive", Keg::Value::basic(Keg::BasicType::UI8, offsetof(Block, isSupportive)));
