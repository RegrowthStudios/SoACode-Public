...
namespace graphics {
    ...
    ui32 GpuMemory::_textureVramUsage = 0;
    ui32 GpuMemory::_bufferVramUsage = 0;

    std::unordered_map<ui32, ui32> GpuMemory::_textures;
    std::unordered_map<ui32, ui32> GpuMemory::_buffers;
    ...
    void GpuMemory::uploadBufferData(ui32 bufferID, BufferTarget target, ui32 bufferSize, const void* data, BufferUsage usage)
    {
    ...
    void GpuMemory::freeBuffer(ui32& bufferID)
    {
